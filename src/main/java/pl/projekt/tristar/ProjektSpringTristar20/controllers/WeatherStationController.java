...
public class WeatherStationController {
    ...
    @GetMapping(path = "/history/{id}/{limit}/{direction}")
    public String history(@PathVariable("id") int id, @PathVariable("limit") int limit,@PathVariable("direction") String dir , Model model) {
